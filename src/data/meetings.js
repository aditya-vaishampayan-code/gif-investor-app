...
export const MEETINGS_DATA = [
  ...
  },
  {
    ...
    userName: 'Aditya',
    title: 'PharmaTech Supply Chain Strategy',
    partnerName: 'Talha Shaikh',
    partnerRole: 'Co-Founder, Business & Operations, Biddano',
    partnerCompany: 'Biddano',
    ...
    status: 'Confirmed',
    notes: 'Pharma distribution AI stack and secondary-sales data network review.',
  },
]
