...
export default function Shell({ title, back, children }) {
  return (
    <div className="min-h-screen">
      <header className="sticky top-0 z-10 bg-ink/90 backdrop-blur border-b border-gold/20">
        <div className="max-w-md mx-auto flex items-center h-14 px-4">
          ...
          <h1 className="font-display text-xl font-semibold tracking-wide text-fog">{title}</h1>
        </div>
      </header>
